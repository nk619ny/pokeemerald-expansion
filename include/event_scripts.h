...
extern const u8 EventScript_BrineyBoardBoat[];
...
extern const u8 AquaHideout_B2F_EventScript_StevenCallOutro[];
extern const u8 MagmaHideout_4F_EventScript_StevenCallOutro[];
...
extern const u8 BerryTree_EventScript_ItemUseCannotPlantBerry[];
