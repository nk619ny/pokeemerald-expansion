...
enum __attribute__((packed)) Species
{
    ...
    SPECIES_POKESTAR_BLACK_DOOR = 1601,
    SPECIES_POKESTAR_F_00 = 1602,
    SPECIES_POKESTAR_F_002 = 1603,
    SPECIES_POKESTAR_HUMANOID = 1604,
    SPECIES_POKESTAR_SPIRIT = 1605,
    SPECIES_POKESTAR_MT = 1606,
    SPECIES_POKESTAR_MT2 = 1607,
    SPECIES_POKESTAR_MONSTER = 1608,
    SPECIES_POKESTAR_TRANSPORT = 1609,
    SPECIES_POKESTAR_UFO = 1610,
    SPECIES_POKESTAR_UFO_2 = 1611,
    SPECIES_POKESTAR_WHITE_DOOR = 1612,

    // Custom Starmobile Forms
    SPECIES_REVAVROOM_SEGIN = 1613,
    SPECIES_REVAVROOM_SCHEDAR = 1614,
    SPECIES_REVAVROOM_NAVI = 1615,
    SPECIES_REVAVROOM_RUCHBAH = 1616,
    SPECIES_REVAVROOM_CAPH = 1617,
