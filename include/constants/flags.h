...
#define FLAG_HIDE_EVER_GRANDE_POKEMON_CENTER_1F_SCOTT               0x319 // now unused and available for repurposing
...
#define FLAG_ITEM_ROUTE_119_LEAF_STONE                              0x403 //now unused, available to use
...
#define FLAG_ITEM_ABANDONED_SHIP_HIDDEN_FLOOR_ROOM_1_TM_RAIN_DANCE  0x44E // now unused & available for repurposing
