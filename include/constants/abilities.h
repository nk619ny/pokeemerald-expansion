...
enum __attribute__((packed)) Ability
{
    ...
    // Custom abilities
    ABILITY_DARK_CLOUDS = 319,
    ABILITY_BLITZ_BOXER = 320,
    ABILITY_SUB_ZERO = 321,
    ABILITY_SMOKE_CLOUD = 322,
    ABILITY_SANDGEIST = 323,
    ABILITY_SPOUT_SPRAY = 324,
    ABILITY_TIME_TRAVELER = 325,
    ABILITY_WOODWORKER = 326,
    ABILITY_MUDDY = 327,
    ABILITY_ABUNDANCE = 328,
    ABILITY_CYCLONE_SHIFT = 329,
    ABILITY_WHITE_OUT = 330,
    ABILITY_SPREAD_FISTS = 331,
    ABILITY_DESERT_SPIRIT = 332,
    ABILITY_BEETLE_SUMO = 333,
    ABILITY_EELEVATE = 334,
    ABILITIES_COUNT_CUSTOM = 335,
