...
enum __attribute__((packed)) Ability
{
    ...
    // Custom abilities
    ABILITY_DARK_CLOUDS = 320,
    ABILITY_BLITZ_BOXER = 321,
    ABILITY_SUB_ZERO = 322,
    ABILITY_SMOKE_CLOUD = 323,
    ABILITY_SANDGEIST = 324,
    ABILITY_SPOUT_SPRAY = 325,
    ABILITY_TIME_TRAVELER = 326,
    ABILITY_WOODWORKER = 327,
    ABILITY_MUDDY = 328,
    ABILITY_ABUNDANCE = 329,
    ABILITY_CYCLONE_SHIFT = 330,
    ABILITY_WHITE_OUT = 331,
    ABILITY_SPREAD_FISTS = 332,
    ABILITY_DESERT_SPIRIT = 333,
    ABILITY_BEETLE_SUMO = 334,
    ABILITY_SPEED_FORCE = 335,
    ABILITY_ANGULAR_ACCELERATION = 336,
    ABILITIES_COUNT_CUSTOM = 337,
