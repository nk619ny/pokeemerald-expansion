...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_DARK_CLOUDS = ABILITIES_COUNT_GEN9,
    ABILITY_BLITZ_BOXER = 312,
    ABILITY_SUB_ZERO = 313,
    ABILITY_SMOKE_CLOUD = 314,
    ABILITY_SANDGEIST = 315,
    ABILITY_SPOUT_SPRAY = 316,
    ABILITY_TIME_TRAVELER = 317,
    ABILITY_WOODWORKER = 318,
    ABILITY_MUDDY = 319,
    ABILITY_ABUNDANCE = 320,
    ABILITY_CYCLONE_SHIFT = 321,
    ABILITY_WHITE_OUT = 322,
    ABILITY_SPREAD_FISTS = 323,
    ABILITY_DRAGONIZE = 324,
    ABILITY_MEGA_SOL = 325,
    ABILITY_DESERT_SPIRIT = 326,
