...
enum StringID
{
    ...
    STRINGID_HOSPITALITYRESTORATIONGENERIC,
    ...
    STRINGID_PKMNMADEASTORM,
    STRINGID_ABILITYLOWEREDSURROUNDINGEVASION,
    STRINGID_POWERHERB_RECHARGE,
    STRINGID_DAMPWEAKENEDFIRE,
    STRINGID_MUDDYWEAKENEDELECTRIC,
    STRINGID_TARGETCOVEREDINSTICKYTAR,
    STRINGID_TARGETISBEINGCONSTRICTED,
    STRINGID_HONEYRESTOREDHEALTH,
    STRINGID_ANTICIPATIONSWITCHIN,
    STRINGID_ANTICIPATIONREDUCESDMG,
    STRINGID_COUNT
};
...
enum SwitchInAbilityStringID
{
    ...
    B_MSG_SWITCHIN_ILLUMINATE,
    B_MSG_SWITCHIN_ANTICIPATION_ATTACKS,
};
