...
#define VAR_TRAINER_HILL_STATE                           0x405F // formerly unused, Ever Grande City State
...
#define VAR_FOSSIL_RESURRECTION_STATE                    0x40C4 //can probably be repurposed
#define VAR_WHICH_FOSSIL_REVIVED                         0x40C5 //can probably be repurposed
...
#define VAR_UNUSED_DEX_UPGRADE_JOHTO_STARTER_STATE              0x40D3 // now unused, available to be repurposed
...
#define VAR_SOOTOPOLIS_WALLACE_STATE                     0x40D8 //was used for Wallace, now unused and available to be repurposed
...
#define VAR_ROXANNE_CALL_STEP_COUNTER                    0x40F4 //now unused, available for repurposing
#define VAR_SCOTT_BF_CALL_STEP_COUNTER                   0x40F5
#define VAR_RIVAL_RAYQUAZA_CALL_STEP_COUNTER             0x40F6
#define VAR_STEVEN_AQUA_CALL_STEP_COUNTER                0x40F7 // formerly not used
#define VAR_STEVEN_MAGMA_CALL_STEP_COUNTER               0x40F8 // formerly not used
#define VAR_UNUSED_0x40F9                                0x40F9 // Unused Var
#define VAR_UNUSED_0x40FA                                0x40FA // Unused Var
#define VAR_UNUSED_0x40FB                                0x40FB // Unused Var
#define VAR_HIGHEST_LEVEL_HANDICAP                       0x40FC // Formerly not used
