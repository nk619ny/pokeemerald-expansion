...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FAIRY_TALE_GIRL_ORAS,
...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_STREET_THUG,
    TRAINER_CLASS_MECHA_DOLL,
    TRAINER_CLASS_ACE_DUO,
    TRAINER_CLASS_BRAINS_AND_BRAWN,
    TRAINER_CLASS_MYSTERIOUS_SISTERS,
