...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_COURTNEY_ORAS, 
    TRAINER_PIC_FRONT_TABITHA_ORAS,
    TRAINER_PIC_FRONT_SHELLY_ORAS,
    TRAINER_PIC_FRONT_MATT_ORAS,
    TRAINER_PIC_FRONT_ARCHIE_ORAS,
    TRAINER_PIC_FRONT_MAXIE_ORAS,
    TRAINER_PIC_FRONT_PROFESSOR_TURO,
    TRAINER_PIC_FRONT_PROFESSOR_SADA,
    TRAINER_PIC_FRONT_VITO,
    TRAINER_PIC_FRONT_LISIA,
    TRAINER_PIC_FRONT_ZINNIA,
    TRAINER_PIC_FRONT_STREET_THUG_ORAS,
    TRAINER_PIC_FRONT_BACKPACKER_ORAS,
    TRAINER_PIC_FRONT_DELINQUENT_ORAS,
    TRAINER_PIC_FRONT_DIVER_F_ORAS,
    TRAINER_PIC_FRONT_DIVER_M_ORAS,
    ...
    TRAINER_PIC_BACK_MATT,
    TRAINER_PIC_BACK_TABITHA,
    TRAINER_PIC_COUNT,
