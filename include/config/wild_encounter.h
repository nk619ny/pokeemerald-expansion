...
#define WE_FLAG_NO_ENCOUNTER        FLAG_PREVENT_WILD_ENCOUNTERS       // If this flag is set, wild encounters will be disabled.

// Double Wild Battles
#define WE_DOUBLE_WILD_CHANCE            12          // % chance of encountering two Pokémon in a Wild Encounter.
