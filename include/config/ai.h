...
#define ACUPRESSURE_ROLL_CHANCE                                 25 // Chance the AI will use Acupressure on itself/ally once ShouldRaiseAnyStat allows it, outside of its skip-roll exceptions
