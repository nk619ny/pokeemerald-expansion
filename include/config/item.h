...
// Item config
#define I_SHINY_CHARM_ADDITIONAL_ROLLS  15           // Amount of additional shiny rolls if the player has the Shiny Charm. Set it to 0 to disable Shiny Charm's effects.
