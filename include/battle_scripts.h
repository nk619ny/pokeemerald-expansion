...
extern const u8 BattleScript_HoneyHealHP_End2[];
...
extern const u8 BattleScript_CycloneShiftActivates[];
...
extern const u8 BattleScript_HealerSwitchInActivates[];
...
extern const u8 BattleScript_MuddyActivates[];
...
extern const u8 BattleScript_HospitalityActivatesGeneric[];
...
extern const u8 BattleScript_TarShotStickyActivates[];
extern const u8 BattleScript_TarShotEndTurn[];
extern const u8 BattleScript_ConstrictStickyActivates[];
extern const u8 BattleScript_ConstrictEndTurn[];
...
extern const u8 BattleScript_MoveEffectSteelsurgeOriginal[];
