...
enum RandomTag
{
    ...
    RNG_AI_HARD_TRICK_ROOM_OVER_FAST_KILL,
    RNG_AI_ILLUSION_TRICK,
    RNG_AI_REVERSE_BATTLER_LOGIC_ORDER,
    RNG_AI_AVOID_DOUBLE_TARGET_KO,
    RNG_AI_DOUBLE_TARGET_SLOW_KILL,
    RNG_AI_DOUBLE_TARGET_INSURANCE,
    RNG_AI_AVOID_WIDE_GUARD_SPREAD,
    RNG_CUSTOM_STRATEGIES,
    RNG_WRAP,
