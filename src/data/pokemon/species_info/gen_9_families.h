...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_CROCALOR] =
    {
        ...
        .eliteLearnset = sNoneEliteLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_SKELEDIRGE}),
    },
    ...
    [SPECIES_QUAXLY] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_MOXIE, ABILITY_TANGLED_FEET },
    ...
    [SPECIES_QUAXWELL] =
    {
        ...
        .eliteLearnset = sNoneEliteLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_QUAQUAVAL}),
    },
    ...
    [SPECIES_QUAQUAVAL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_TORRENT, ABILITY_MOXIE, ABILITY_DANCER },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .eliteLearnset = sQuaquavalEliteLearnset,
    },
    ...
    [SPECIES_LECHONK] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_OINKOLOGNE_M, CONDITIONS({IF_GENDER, MON_MALE})},
                                ...
                                {EVO_ITEM, ITEM_HEART_STONE, SPECIES_OINKOLOGNE_M, CONDITIONS({IF_GENDER, MON_FEMALE})},
                                {EVO_ITEM, ITEM_HEART_STONE, SPECIES_OINKOLOGNE_F, CONDITIONS({IF_GENDER, MON_MALE})}),
    },

    [SPECIES_OINKOLOGNE_M] =
    {
        .baseHP        = 110,
        .baseAttack    = 100  + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 5 : 0),
        .baseDefense   = 75  + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 15 : 0),
        .baseSpeed     = 65  + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseSpAttack  = 59,
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 100,
        ...
        .eliteLearnset = sOinkolongneEliteLearnset,
    ...
    {
        .baseHP        = 115,
        .baseAttack    = 90  + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 5 : 0),
        .baseDefense   = 70  + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 15 : 0),
        .baseSpeed     = 65 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 5 : 0),
        .baseSpAttack  = 59,
        .baseSpDefense = 90  + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 5 : 0),
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 100,
        .expYield = 171,
        .evYield_HP = 2,
    ...
    [SPECIES_TAROUNTULA] =
    {
        ...
        .abilities = { ABILITY_INSOMNIA, ABILITY_STAKEOUT, ABILITY_NONE }, //moved HA to A2
        .bodyColor = BODY_COLOR_WHITE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 16, SPECIES_SPIDOPS}),
    },

    [SPECIES_SPIDOPS] =
    {
        .baseHP        = 60 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 20 : 0),
        .baseAttack    = 79 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 25 : 0),
        .baseDefense   = 92 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseSpeed     = 35,
        .baseSpAttack  = 52,
        .baseSpDefense = 86 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 5 : 0),
        .types = MON_TYPES(TYPE_BUG),
        .catchRate = 120,
        .expYield = 141,
        .evYield_Defense = 2,
    ...
    [SPECIES_NYMBLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_TINTED_LENS, ABILITY_NONE }, //moved HA to A2
        .bodyColor = BODY_COLOR_GRAY,
    ...
    {
        .baseHP        = 71,
        .baseAttack    = 102 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseDefense   = 78,
        .baseSpeed     = 92+ (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 5 : 0),
        .baseSpAttack  = 52,
        .baseSpDefense = 55+ (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 15 : 0),
    ...
    [SPECIES_PAWMOT] =
    {
        .baseHP        = 70 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 5 : 0),
        .baseAttack    = 115,
        .baseDefense   = 70 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseSpeed     = 105,
        .baseSpAttack  = 70,
        .baseSpDefense = 60 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_FIGHTING),
        .catchRate = 45,
        .expYield = 245,
        .evYield_Attack = 3,
    ...
    {
        .baseHP        = 74,
        .baseAttack    = 75 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseDefense   = 70,
        .baseSpeed     = 111,
        .baseSpAttack  = 65,
        .baseSpDefense = 75,
    ...
    [SPECIES_FIDOUGH] =
    {
        ...
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_PICKUP, ABILITY_KLUTZ },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_DACHSBUN] =
    {
        .baseHP        = (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 80 : 57),
        .baseAttack    = 80 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 5 : 0),
        .baseDefense   = 115,
        .baseSpeed     = 95,
        .baseSpAttack  = 50,
        .baseSpDefense = 80,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_WELL_BAKED_BODY, ABILITY_PICKUP, ABILITY_AROMA_VEIL },
        ...
        .eliteLearnset = sDachsbunEliteLearnset,
    },
    ...
    [SPECIES_ARBOLIVA] =
    {
        .baseHP        = 78 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 5 : 0),
        .baseAttack    = 69,
        .baseDefense   = 90,
        .baseSpeed     = 39,
        .baseSpAttack  = 125,
        .baseSpDefense = 109 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 5 : 0),
        .types = MON_TYPES(TYPE_GRASS, TYPE_NORMAL),
        .catchRate = 45,
        .expYield = 255,
        .evYield_SpAttack = 3,
    ...
    {
        .baseHP        = 82,
        .baseAttack    = 96 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 5 : 0),
        .baseDefense   = 51 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseSpeed     = 92 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 5 : 0),
        .baseSpAttack  = 45,
        .baseSpDefense = 51 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0) + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
    ...
    [SPECIES_SQUAWKABILLY_BLUE] =
    {
        .baseHP        = 82,
        .baseAttack    = 96 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 5 : 0),
        .baseDefense   = 51 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0) + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 5 : 0),
        .baseSpeed     = 92 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseSpAttack  = 45,
        .baseSpDefense = 51 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING),
        .catchRate = 190,
        .expYield = 146,
        .evYield_Attack = 1,
    ...
    {
        .baseHP        = 82,
        .baseAttack    = 96 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseDefense   = 51 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0) + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseSpeed     = 92,
        .baseSpAttack  = 45,
        .baseSpDefense = 51 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING),
    ...
    [SPECIES_GARGANACL] =
    {
        ...
        .eliteLearnset = sGarganacleEliteLearnset,
    },
    ...
    [SPECIES_CHARCADET] =
    {
        ...
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_FLAME_BODY, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_ARMAROUGE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_WEAK_ARMOR, ABILITY_MEGA_LAUNCHER }, //added ABILITY_MEGA_LAUNCHER
        .bodyColor = BODY_COLOR_RED,
        ...
        .eliteLearnset = sArmarougeEliteLearnset,
    },
    ...
    [SPECIES_CERULEDGE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_WEAK_ARMOR, ABILITY_SHARPNESS }, //added ABILITY_SHARPNESS
        ...
        .eliteLearnset = sCeruledgeEliteLearnset,
    },
    ...
    [SPECIES_KILOWATTREL] =
    {
        ...
        .eliteLearnset = sKilowattrelEliteLearnset,
    },
    ...
    {
        .baseHP        = 55 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseAttack    = 115,
        .baseDefense   = 70,
        .baseSpeed     = 90 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 5 : 0),
        .baseSpAttack  = 80,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_GRASS, TYPE_GHOST),
        .catchRate = 45,
        ...
        .eliteLearnset = sBrambleghastEliteLearnset,
    },
    ...
    [SPECIES_TOEDSCOOL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_MYCELIUM_MIGHT, ABILITY_NONE, ABILITY_SLOW_START }, //added Slow Start to HA
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_KLAWF] =
    {
        .baseHP        = 70 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseAttack    = 100 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseDefense   = 115,
        .baseSpeed     = 75,
        .baseSpAttack  = 35,
        .baseSpDefense = 55 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .types = MON_TYPES(TYPE_ROCK),
        .catchRate = 120,
        .expYield = 158,
        .evYield_Defense = 2,
        ...
        .eliteLearnset = sKlawfEliteLearnset,
    ...
    [SPECIES_RABSCA] =
    {
        .baseHP        = 75 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseAttack    = 50,
        .baseDefense   = 85,
        .baseSpeed     = 45,
        .baseSpAttack  = 115,
        .baseSpDefense = 100 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 5 : 0),
        ...
        .eliteLearnset = sRabscaEliteLearnset,
    },
    ...
    [SPECIES_ESPATHRA] =
    {
        .baseHP        = 95,
        .baseAttack    = 60,
        .baseDefense   = 60 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 5 : 0),
        .baseSpeed     = 105,
        .baseSpAttack  = 101 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 4 : 0),
        .baseSpDefense = 60 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 5 : 0),
        .types = MON_TYPES(TYPE_PSYCHIC),
        .catchRate = 60,
        .expYield = 168,
        .evYield_Speed = 2,
        ...
        .eliteLearnset = sEspathaEliteLearnset,
    },
    ...
    [SPECIES_TINKATON] =
    {
        .baseHP        = 85,
        .baseAttack    = 75 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseDefense   = 77 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseSpeed     = 94,
        .baseSpAttack  = 70,
        .baseSpDefense = 105,
        .types = MON_TYPES(TYPE_FAIRY, TYPE_STEEL),
        ...
        .eliteLearnset = sTinkatonEliteLearnset,
    },
    ...
    [SPECIES_WUGTRIO] =
    {
        .baseHP        = 35,
        .baseAttack    = 100 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseDefense   = 50 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseSpeed     = 120 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseSpAttack  = 50,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_WATER),
        .catchRate = 50,
        ...
        .eliteLearnset = sWugtrioEliteLearnset,
    },
    ...
    [SPECIES_PALAFIN_ZERO] =
    {
        ...
        .eliteLearnset = sPalafineEliteLearnset,
    ...
    [SPECIES_VAROOM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_OVERCOAT, ABILITY_FILTER, ABILITY_SLOW_START },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_REVAVROOM] =
    {
        ...
        .eliteLearnset = sRevavroomEliteLearnset,
    },
    ...
    [SPECIES_REVAVROOM_SEGIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_FILTER, ABILITY_SLOW_START },
        .bodyColor = BODY_COLOR_GRAY,
        ...
        .weight = 1200,
        .description = COMPOUND_STRING(
            "A Revavroom that has absorbed Segin's\n"
            "star power. It powers its cylinders\n"
            "with stellar energy."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_RevavroomSegin,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        ...
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 16,
        .palette = gMonPalette_RevavroomSegin,
    ...
    [SPECIES_REVAVROOM_SCHEDAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SPEED_BOOST, ABILITY_FILTER, ABILITY_SLOW_START },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Starmobile"),
        .cryId = CRY_REVAVROOM,
        .natDexNum = NATIONAL_DEX_REVAVROOM,
        ...
        .weight = 1200,
        .description = COMPOUND_STRING(
            "A Revavroom that has absorbed Schedar's\n"
            "star power. It powers its cylinders\n"
            "with stellar energy."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_RevavroomSchedar,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .backPic = gMonBackPic_CircledQuestionMark,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 16,
        .palette = gMonPalette_RevavroomSchedar,
        .shinyPalette = gMonShinyPalette_CircledQuestionMark,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_REVAVROOM_NAVI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_TOXIC_DEBRIS, ABILITY_FILTER, ABILITY_SLOW_START },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Starmobile"),
        .cryId = CRY_REVAVROOM,
        .natDexNum = NATIONAL_DEX_REVAVROOM,
        ...
        .weight = 1200,
        .description = COMPOUND_STRING(
            "A Revavroom that has absorbed Navi's\n"
            "star power. It powers its cylinders\n"
            "with stellar energy."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_RevavroomNavi,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .backPic = gMonBackPic_CircledQuestionMark,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 16,
        .palette = gMonPalette_RevavroomNavi,
        .shinyPalette = gMonShinyPalette_CircledQuestionMark,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_REVAVROOM_RUCHBAH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_MISTY_SURGE, ABILITY_FILTER, ABILITY_SLOW_START },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Starmobile"),
        .cryId = CRY_REVAVROOM,
        .natDexNum = NATIONAL_DEX_REVAVROOM,
        ...
        .weight = 1200,
        .description = COMPOUND_STRING(
            "A Revavroom that has absorbed Ruchbah's\n"
            "star power. It powers its cylinders\n"
            "with stellar energy."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_RevavroomRuchbah,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .backPic = gMonBackPic_CircledQuestionMark,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 16,
        .palette = gMonPalette_RevavroomRuchbah,
        .shinyPalette = gMonShinyPalette_CircledQuestionMark,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_REVAVROOM_CAPH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_STAMINA, ABILITY_FILTER, ABILITY_SLOW_START },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Starmobile"),
        .cryId = CRY_REVAVROOM,
        .natDexNum = NATIONAL_DEX_REVAVROOM,
        ...
        .weight = 1200,
        .description = COMPOUND_STRING(
            "A Revavroom that has absorbed Caph's\n"
            "star power. It powers its cylinders\n"
            "with stellar energy."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_RevavroomCaph,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .backPic = gMonBackPic_CircledQuestionMark,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 16,
        .palette = gMonPalette_RevavroomCaph,
        .shinyPalette = gMonShinyPalette_CircledQuestionMark,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_CYCLIZAR] =
    {
        ...
        .eliteLearnset = sCyclizarEliteLearnset,
    ...
    {
        .baseHP        = 70,
        .baseAttack    = 85 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 15 : 0),
        .baseDefense   = 145,
        .baseSpeed     = 65,
        .baseSpAttack  = 60,
        .baseSpDefense = 55 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_EARTH_EATER, ABILITY_SAND_VEIL, ABILITY_NONE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_GREAVARD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAND_RUSH, ABILITY_PICKUP, ABILITY_FLUFFY },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_HOUNDSTONE] =
    {
        .baseHP        = 72 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 8 : 0),
        .baseAttack    = 101 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 9 : 0),
        .baseDefense   = 100,
        .baseSpeed     = 68,
        .baseSpAttack  = 50,
        .baseSpDefense = 97,
        ...
        .eliteLearnset = sHoundstoneEliteLearnset,
    },
    ...
    [SPECIES_FLAMIGO] =
    {
        .baseHP        = 82 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseAttack    = 115,
        .baseDefense   = 74,
        .baseSpeed     = 90,
        .baseSpAttack  = 75,
        .baseSpDefense = 64 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 5 : 0),
        ...
        .eliteLearnset = sFlamigoEliteLearnset,
    ...
    [SPECIES_VELUZA] =
    {
        .baseHP        = 90 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseAttack    = 102,
        .baseDefense   = 73 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseSpeed     = 70,
        .baseSpAttack  = 78,
        .baseSpDefense = 65 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        ...
        .eliteLearnset = sVeluzaEliteLearnset,
    ...
    [SPECIES_TATSUGIRI_CURLY] =
    {
        ...
        .baseAttack    = 50,
        .baseDefense   = 60 + (B_CUSTOMIZED_GEN_9_STATS == TRUE ? 10 : 0),
        .baseSpeed     = 82,
        .baseSpAttack  = 120,
        .baseSpDefense = 95,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_COMMANDER, ABILITY_STORM_DRAIN, ABILITY_NONE }, //moved HA to A2
        .bodyColor = BODY_COLOR_RED,
        ...
        .eliteLearnset = sTatsugiriEliteLearnset,
    ...
    [SPECIES_GREAT_TUSK] =
    {
        ...
        .eliteLearnset = sGreatTuskEliteLearnset,
    },
    ...
    [SPECIES_SCREAM_TAIL] =
    {
        ...
        .eliteLearnset = sScreamTailEliteLearnset,
    },
    ...
    [SPECIES_SLITHER_WING] =
    {
        ...
        .eliteLearnset = sSlitherWingEliteLearnset,
    },
    ...
    [SPECIES_SANDY_SHOCKS] =
    {
        ...
        .eliteLearnset = sSandyShocksEliteLearnset,
    },
    ...
    [SPECIES_IRON_TREADS] =
    {
        ...
        .eliteLearnset = sIronTreadsEliteLearnset,
    },
    ...
    [SPECIES_IRON_MOTH] =
    {
        ...
        .eliteLearnset = sIronMothEliteLearnset,
    },
    ...
    [SPECIES_IRON_THORNS] =
    {
        ...
        .eliteLearnset = sIronThornsEliteLearnset,
    },
    ...
    [SPECIES_BAXCALIBUR] =
    {
        ...
        .eliteLearnset = sBaxcaliburEliteLearnset,
    ...
    [SPECIES_GIMMIGHOUL_CHEST] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 70, SPECIES_GHOLDENGO}),    
    },
    ...
    [SPECIES_GHOLDENGO] =
    {
        ...
        .eliteLearnset = sGholdengoEliteLearnset,
    },
    ...
    [SPECIES_WO_CHIEN] =
    {
        ...
        .eliteLearnset = sWoChienEliteLearnset,
    },
    ...
    [SPECIES_CHIEN_PAO] =
    {
        ...
        .eliteLearnset = sChienPaoEliteLearnset,
    },
    ...
    [SPECIES_ROARING_MOON] =
    {
        ...
        .eliteLearnset = sRoaringMoonEliteLearnset,
    },
    ...
    [SPECIES_IRON_VALIANT] =
    {
        ...
        .eliteLearnset = sIronValiantEliteLearnset,
    },
    ...
    [SPECIES_KORAIDON] =
    {
        ...
        .eliteLearnset = sKoraidonEliteLearnset,
    },
    ...
    [SPECIES_MIRAIDON] =
    {
        ...
        .eliteLearnset = sMiraidonEliteLearnset,
    },
    ...
    [SPECIES_WALKING_WAKE] =
    {
        ...
        .eliteLearnset = sWalkingWakeEliteLearnset,
    },
    ...
    [SPECIES_IRON_LEAVES] =
    {
        ...
        .eliteLearnset = sIronLeavesEliteLearnset,
    },
    ...
    [SPECIES_POLTCHAGEIST_COUNTERFEIT] =
    {
        ...
        .abilities = { ABILITY_HOSPITALITY, ABILITY_HEATPROOF, ABILITY_NONE }, //moved HA to A2
        .bodyColor = BODY_COLOR_GREEN,
...
#define OGERPON_SPECIES_INFO(Form1, Form2, type, ability, color, frontYOffset, iconpalette, isTeraform)    \
    ...
    [SPECIES_POKESTAR_BLACK_DOOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_EARLY_BIRD, ABILITY_WOODWORKER, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Black Door"),
        .cryId = CRY_PORYGON,
        ...
        .weight = 0,
        .description = COMPOUND_STRING(
            "This is a placeholder species."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_PokestarBlackDoor,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .backPic = gMonBackPic_CircledQuestionMark,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 12,
        .palette = gMonPalette_PokestarBlackDoor,
        .shinyPalette = gMonShinyPalette_CircledQuestionMark,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_POKESTAR_F_00] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_PokestarF00,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .backPic = gMonBackPic_CircledQuestionMark,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 12,
        .palette = gMonPalette_PokestarF00,
        .shinyPalette = gMonShinyPalette_CircledQuestionMark,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_POKESTAR_F_002] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_PokestarF002,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .backPic = gMonBackPic_CircledQuestionMark,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 12,
        .palette = gMonPalette_PokestarF002,
        .shinyPalette = gMonShinyPalette_CircledQuestionMark,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_POKESTAR_HUMANOID] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_PokestarHumanoid,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .backPic = gMonBackPic_CircledQuestionMark,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 12,
        .palette = gMonPalette_PokestarHumanoid,
        .shinyPalette = gMonShinyPalette_CircledQuestionMark,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_POKESTAR_SPIRIT] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_PokestarMajin,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .backPic = gMonBackPic_CircledQuestionMark,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 12,
        .palette = gMonPalette_PokestarMajin,
        .shinyPalette = gMonShinyPalette_CircledQuestionMark,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_POKESTAR_MT] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_PokestarMt,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .backPic = gMonBackPic_CircledQuestionMark,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 12,
        .palette = gMonPalette_PokestarMt,
        .shinyPalette = gMonShinyPalette_CircledQuestionMark,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_POKESTAR_MT2] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_PokestarMt2,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .backPic = gMonBackPic_CircledQuestionMark,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 12,
        .palette = gMonPalette_PokestarMt2,
        .shinyPalette = gMonShinyPalette_CircledQuestionMark,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_POKESTAR_MONSTER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_SOUNDPROOF, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Monster"),
        .cryId = CRY_PORYGON,
        .natDexNum = NATIONAL_DEX_NONE,
        .categoryName = _("Placeholder"),
        .height = 0,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_PokestarMonster,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .backPic = gMonBackPic_CircledQuestionMark,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 12,
        .palette = gMonPalette_PokestarMonster,
        .shinyPalette = gMonShinyPalette_CircledQuestionMark,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_POKESTAR_TRANSPORT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_TIME_TRAVELER, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Transport"),
        .cryId = CRY_PORYGON,
        .natDexNum = NATIONAL_DEX_NONE,
        .categoryName = _("Placeholder"),
        .height = 0,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_PokestarTransport,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .backPic = gMonBackPic_CircledQuestionMark,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 12,
        .palette = gMonPalette_PokestarTransport,
        .shinyPalette = gMonShinyPalette_CircledQuestionMark,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_POKESTAR_UFO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LEVITATE, ABILITY_MOTOR_DRIVE, ABILITY_TELEPATHY },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("UFO"),
        .cryId = CRY_PORYGON,
        .natDexNum = NATIONAL_DEX_NONE,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_PokestarUfo,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .backPic = gMonBackPic_CircledQuestionMark,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 12,
        .palette = gMonPalette_PokestarUfo,
        .shinyPalette = gMonShinyPalette_CircledQuestionMark,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_POKESTAR_UFO_2] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_PokestarUfo2,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .backPic = gMonBackPic_CircledQuestionMark,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 12,
        .palette = gMonPalette_PokestarUfo2,
        .shinyPalette = gMonShinyPalette_CircledQuestionMark,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_POKESTAR_WHITE_DOOR] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_PokestarWhiteDoor,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .backPic = gMonBackPic_CircledQuestionMark,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 12,
        .palette = gMonPalette_PokestarWhiteDoor,
        .shinyPalette = gMonShinyPalette_CircledQuestionMark,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
