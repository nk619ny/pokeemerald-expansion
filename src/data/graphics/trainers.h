...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_COURTNEY_ORAS, gTrainerFrontPic_CourtneyORAS, gTrainerPalette_CourtneyORAS),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_TABITHA_ORAS, gTrainerFrontPic_TabithaORAS, gTrainerPalette_TabithaORAS),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_SHELLY_ORAS, gTrainerFrontPic_ShellyORAS, gTrainerPalette_ShellyORAS),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_MATT_ORAS, gTrainerFrontPic_MattORAS, gTrainerPalette_MattORAS),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_ARCHIE_ORAS, gTrainerFrontPic_ArchieORAS, gTrainerPalette_ArchieORAS),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_MAXIE_ORAS, gTrainerFrontPic_MaxieORAS, gTrainerPalette_MaxieORAS),
