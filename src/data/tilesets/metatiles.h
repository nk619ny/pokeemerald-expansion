...
const u16 gMetatiles_Glacier[] = INCBIN_U16("data/tilesets/secondary/glacier/metatiles.bin");
const u16 gMetatileAttributes_Glacier[] = INCBIN_U16("data/tilesets/secondary/glacier/metatile_attributes.bin");
