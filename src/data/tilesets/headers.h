...
const struct Tileset gTileset_Glacier =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Glacier,
    .palettes = gTilesetPalettes_Glacier,
    .metatiles = gMetatiles_Glacier,
    .metatileAttributes = gMetatileAttributes_Glacier,
    .callback = NULL,
};
