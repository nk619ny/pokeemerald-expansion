...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_DOUBLE_SLAP] =
    {
        ...
        .power = 15,
        .type = TYPE_NORMAL,
        .accuracy = B_CUSTOMIZED_MOVE_STATS == TRUE ? 100 : 85,
        .pp = 10,
        .target = TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_COMET_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "2 to 5 times."),
        .effect = EFFECT_HIT,
        .power = B_CUSTOMIZED_MOVE_STATS == TRUE ? 25 : 18,
        .type = TYPE_BUG,
        .accuracy = B_CUSTOMIZED_MOVE_STATS == TRUE ? 100 : 85,
        .pp = 15,
        .target = TARGET_SELECTED,
    ...
    [MOVE_MEGA_PUNCH] =
    {
        ...
        .power = 80,
        .type = TYPE_NORMAL,
        .accuracy = B_CUSTOMIZED_MOVE_STATS == TRUE ? 90 : 85,
        .pp = 20,
        .target = TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_CUT] =
    {
        ...
        .power = 50,
        .type = TYPE_NORMAL,
        .accuracy = B_CUSTOMIZED_MOVE_STATS == TRUE ? 100 : 95,
        .pp = 30,
        .target = TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_ROLLING_KICK] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_CUSTOMIZED_MOVE_STATS == TRUE ? 80 : 60,
        .type = TYPE_FIGHTING,
        .accuracy = B_CUSTOMIZED_MOVE_STATS == TRUE ? 100 : 85,
        .pp = 15,
        .target = TARGET_SELECTED,
    ...
    [MOVE_PIN_MISSILE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "strike 2 to 5 times."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 20 : 14,
        .type = TYPE_BUG,
    ...
    [MOVE_STRENGTH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "then slams the foe."),
        .effect = EFFECT_HIT,
        .power = B_CUSTOMIZED_MOVE_STATS == TRUE ? 70 : 80,
        .type = B_CUSTOMIZED_MOVE_STATS == TRUE ? TYPE_ROCK : TYPE_NORMAL,
        .accuracy = 100,
        .pp = 15,
        .target = TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_GROWTH] =
    {
        ...
        .power = 0,
        .type = B_CHAMPIONS_MOVE_UPDATES ? TYPE_GRASS : TYPE_NORMAL,
        .accuracy = 0,
    ...
    [MOVE_RAZOR_LEAF] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "High critical-hit ratio."),
        .effect = EFFECT_HIT,
        .power = B_CUSTOMIZED_MOVE_STATS == TRUE ? 50 : 55,
        .type = TYPE_GRASS,
        .accuracy = B_CUSTOMIZED_MOVE_STATS == TRUE ? 100 : 95,
        .criticalHitStage = B_UPDATED_MOVE_DATA >= GEN_3 ? 1 : 2,
        .pp = 25,
    ...
    [MOVE_CONSTRICT] =
    {
        ...
        .makesContact = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_CONSTRICT_SLOW,
            .chance = 100,
        }),
    ...
    [MOVE_CRABHAMMER] =
    {
        ...
        .type = TYPE_WATER,
        .accuracy = B_CUSTOMIZED_MOVE_STATS ? 100 : 95, //champions buffed to 95, so I went the rest of the way
        .criticalHitStage = B_UPDATED_MOVE_DATA >= GEN_3 ? 1 : 2,
        .pp = 10,
        .target = TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_FURY_SWIPES] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_CUSTOMIZED_MOVE_STATS == TRUE ? 15 : 18,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 15,
        .target = TARGET_SELECTED,
    ...
    [MOVE_ROCK_SLIDE] =
    {
        ...
        .power = 75,
        .type = TYPE_ROCK,
        .accuracy = B_PERFECT_SPREAD_ACCURACY == TRUE ? 100 : 90,
        .pp = 10,
        .target = TARGET_BOTH,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_SLASH] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_CHAMPIONS_MOVE_UPDATES ? 80 : 70,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .criticalHitStage = B_UPDATED_MOVE_DATA >= GEN_3 ? 1 : 2,
        .pp = 20,
    ...
    [MOVE_ZAP_CANNON] =
    {
        ...
        .category = DAMAGE_CATEGORY_SPECIAL,
        .ballisticMove = TRUE,
        .alwaysHitsInElectricTerrain = TRUE, // Custom: always hits in Electric Terrain
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_PARALYSIS,
            .chance = 100,
        }),
    ...
    [MOVE_ICY_WIND] =
    {
        ...
        .power = 55,
        .type = TYPE_ICE,
        .accuracy = B_PERFECT_SPREAD_ACCURACY == TRUE ? 100 : 95,
        .pp = 15,
        .target = TARGET_BOTH,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .windMove = TRUE,
        .alwaysHitsInHailSnow = B_CUSTOMIZED_MOVE_STATS == TRUE ? TRUE : FALSE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_STAT_MINUS,
            .speed = 1,
            .chance = 100,
    ...
    [MOVE_BONE_RUSH] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_CUSTOMIZED_MOVE_STATS == TRUE ? 28 : 30, //champions buffed to 30, I left nerfed slightly from there but buffed accuracy
        .type = TYPE_GROUND,
        .accuracy = B_CUSTOMIZED_MOVE_STATS == TRUE ? 100 : 90,
        .pp = 10,
        .target = TARGET_SELECTED,
    ...
    [MOVE_MILK_DRINK] =
    {
        ...
        .accuracy = 0,
        .pp = B_UPDATED_MOVE_DATA >= GEN_9 ? 5 : 10,
        .target = B_CHAMPIONS_MOVE_UPDATES ? TARGET_USER_OR_ALLY : TARGET_USER,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_RESET_STATS },
        .healingMove = TRUE,
    ...
    [MOVE_IRON_TAIL] =
    {
        ...
        .power = 100,
        .type = TYPE_STEEL,
        .accuracy = B_CUSTOMIZED_MOVE_STATS == TRUE ? 85 : 75,
        .pp = 15,
        .target = TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_HEAT_WAVE] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_PERFECT_SPREAD_ACCURACY == TRUE ? 100 : 95,
        .type = TYPE_FIRE,
        ...
        .category = DAMAGE_CATEGORY_SPECIAL,
        .windMove = TRUE,
        .alwaysHitsInSun = TRUE, // Custom: always hits in Sun
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_BURN,
            .chance = 10,
        }),
    ...
    [MOVE_WILL_O_WISP] =
    {
        ...
        .zMove = { .effect = Z_EFFECT_ATK_UP_1 },
        .magicCoatAffected = TRUE,
        .alwaysHitsOnSameType = B_CUSTOMIZED_MOVE_STATS == TRUE ? TRUE : FALSE, // Custom: always hits if user is Fire type (like Toxic for Poison types)
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_SHIFT_JUDGE_ATTENTION : CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
    ...
    [MOVE_SKY_UPPERCUT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Hits flying-types for\n"
            "neutral damage."),
        .effect = EFFECT_NEUTRAL_ON_ARG,
        .power = 85,
        .type = TYPE_FIGHTING,
        .accuracy = B_CUSTOMIZED_MOVE_STATS == TRUE ? 100 : 90,
        .pp = 15,
    ...
    [MOVE_MUDDY_WATER] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 90 : 95,
        .type = TYPE_WATER,
        .accuracy = B_PERFECT_SPREAD_ACCURACY == TRUE ? 100 : 90, //increased from 85 to 90
        .pp = 10,
        .target = TARGET_BOTH,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .skyBattleBanned = TRUE,
        .alwaysHitsInRain = B_CUSTOMIZED_MOVE_STATS == TRUE ? TRUE : FALSE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_STAT_MINUS,
            .accuracy = 1,
            .chance = 30,
    ...
    [MOVE_BOUNCE] =
    {
        ...
        .effect = EFFECT_SEMI_INVULNERABLE,
        .power = B_CUSTOMIZED_MOVE_STATS == TRUE ? 80 : 85,
        .type = TYPE_FLYING,
        .accuracy = B_CUSTOMIZED_MOVE_STATS == TRUE ? 100 : 85,
        .pp = B_CUSTOMIZED_MOVE_STATS == TRUE ? 10 : 5,
        .target = TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_PARALYSIS,
            .chance = B_CUSTOMIZED_MOVE_STATS == TRUE ? 20 : 30,
        }),
        .contestEffect = CONTEST_EFFECT_AVOID_STARTLE,
        .contestCategory = CONTEST_CATEGORY_CUTE,
        .contestComboStarterId = 0,
    ...
    [MOVE_ROCK_BLAST] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_CUSTOMIZED_MOVE_STATS == TRUE ? 20 : 25,
        .type = TYPE_ROCK,
        .accuracy = B_CUSTOMIZED_MOVE_STATS == TRUE ? 100 : 90,
        .pp = 10,
        .target = TARGET_SELECTED,
    ...
    [MOVE_HAMMER_ARM] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_CUSTOMIZED_MOVE_STATS == TRUE ? 95 : 100, // TO BE REVISITED 
        .type = TYPE_FIGHTING,
        .accuracy = B_CUSTOMIZED_MOVE_STATS == TRUE ? 100 : 90,
        .pp = 10,
        .target = TARGET_SELECTED,
    ...
    [MOVE_IRON_HEAD] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_FLINCH,
            .chance = B_CHAMPIONS_MOVE_UPDATES ? 20 : 30,
        }),
        .contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
        .contestComboStarterId = 0,
    ...
    [MOVE_NIGHT_DAZE] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_CHAMPIONS_MOVE_UPDATES ? 90 : 85,
        .type = TYPE_DARK,
        .accuracy = B_CUSTOMIZED_MOVE_STATS == TRUE ? 100 : 95,
        .pp = 10,
        .target = TARGET_SELECTED,
    ...
    [MOVE_GLACIATE] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_CUSTOMIZED_MOVE_STATS == TRUE ? 75 : 65,
        .type = TYPE_ICE,
        .accuracy = B_CUSTOMIZED_MOVE_STATS == TRUE ? 100 : 95, //glaciate specifically has perfect accuracy
        .pp = 10,
        .target = TARGET_BOTH,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
...
*/
    ...
    [MOVE_MOONBLAST] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_STAT_MINUS,
            .spAtk = 1,
            .chance = B_CHAMPIONS_MOVE_UPDATES ? 10 : 30,
        }),
        .contestEffect = CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
    ...
    [MOVE_DIAMOND_STORM] =
    {
        ...
        .target = TARGET_BOTH,
        .priority = 0,
        .category = B_CUSTOMIZED_MOVE_STATS == TRUE ? DAMAGE_CATEGORY_SPECIAL : DAMAGE_CATEGORY_PHYSICAL,
        .metronomeBanned = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_STAT_PLUS,
            .defense = B_UPDATED_MOVE_DATA >= GEN_7 ? 2 : 1,
            .self = TRUE,
            .chance = B_CUSTOMIZED_MOVE_STATS == TRUE ? 40 : 50,
        }),
    ...
    [MOVE_FIRST_IMPRESSION] =
    {
        ...
        .effect = EFFECT_FIRST_TURN_ONLY,
        .power = B_CHAMPIONS_MOVE_UPDATES ? 100 : 90,
        .type = TYPE_BUG,
        .accuracy = 100,
        .pp = 10,
        .target = TARGET_SELECTED,
    ...
    [MOVE_SPIRIT_SHACKLE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "no longer escape."),
        .effect = EFFECT_HIT,
        .power = B_CHAMPIONS_MOVE_UPDATES ? 90 : 80,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 10,
        .target = TARGET_SELECTED,
    ...
    [MOVE_HIGH_HORSEPOWER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "its entire body."),
        .effect = EFFECT_HIT,
        .power = B_CUSTOMIZED_MOVE_STATS == TRUE ? 90 : 95,
        .type = TYPE_GROUND,
        .accuracy = B_CUSTOMIZED_MOVE_STATS == TRUE ? 100 : 95,
        .pp = 10,
        .target = TARGET_SELECTED,
    ...
    [MOVE_TOXIC_THREAD] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = STAT_CHANGE_EFFECT_MINUS,
            .speed = B_CHAMPIONS_MOVE_UPDATES ? 2 : 1,
        }),
    ...
    [MOVE_TROP_KICK] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_CHAMPIONS_MOVE_UPDATES ? 85 : 70,
        .type = TYPE_GRASS,
        .accuracy = 100,
        .pp = 15,
        .target = TARGET_SELECTED,
    ...
    [MOVE_BEAK_BLAST] =
    {
        ...
        .power = B_CHAMPIONS_MOVE_UPDATES ? 120 : 100,
        .type = TYPE_FLYING,
        .accuracy = 100,
        .pp = 15,
        .target = TARGET_SELECTED,
    ...
    [MOVE_SNIPE_SHOT] =
    {
        ...
        .power = B_CHAMPIONS_MOVE_UPDATES ? 85 : 80,
        .type = TYPE_WATER,
        .accuracy = 100,
        .criticalHitStage = B_UPDATED_MOVE_DATA >= GEN_3 ? 1 : 2,
        .pp = 15,
    ...
    [MOVE_METEOR_ASSAULT] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_CHAMPIONS_MOVE_UPDATES ? 170 : 150,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 5,
        .target = TARGET_SELECTED,
    ...
    [MOVE_DIRE_CLAW] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            ...
            .chance = B_CHAMPIONS_MOVE_UPDATES ? 30 : 50,
        }),
    ...
    [MOVE_PSYSHIELD_BASH] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_CHAMPIONS_MOVE_UPDATES ? 90 : 70,
        .type = TYPE_PSYCHIC,
        .accuracy = B_CUSTOMIZED_MOVE_STATS == TRUE ? 100 : 90,
        .pp = 10,
        .target = TARGET_SELECTED,
    ...
    [MOVE_SPRINGTIDE_STORM] =
    {
        ...
        .windMove = TRUE,
        .metronomeBanned = TRUE,
        .alwaysHitsInGrassyTerrain = TRUE, // Custom: always hits in Grassy Terrain
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_STAT_MINUS,
            .attack = 1,
            .chance = 30,
    ...
    [MOVE_MYSTICAL_POWER] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            ...
            .spAtk = 1,
            .self = TRUE,
            .chance = B_CUSTOMIZED_MOVE_STATS == TRUE ? 80 : 100, //TO BE REVISITED
        }),
    ...
    [MOVE_BITTER_MALICE] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_FREEZE_OR_FROSTBITE,
            .chance = B_USE_FROSTBITE == TRUE ? 30 : 10,
        }),
    ...
    [MOVE_INFERNAL_PARADE] =
    {
        ...
        .effect = EFFECT_DOUBLE_POWER_ON_ARG_STATUS,
        .power = B_CHAMPIONS_MOVE_UPDATES ? 65 : 60,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 15,
        .target = TARGET_SELECTED,
    ...
    [MOVE_SANDSEAR_STORM] =
    {
        ...
        .category = DAMAGE_CATEGORY_SPECIAL,
        .windMove = TRUE,
        .alwaysHitsInSandstorm = TRUE, // Custom: always hits in Sandstorm
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_BURN,
            .chance = 20,
        }),
    ...
    [MOVE_MAKE_IT_RAIN] =
    {
        ...
        .power = 120,
        .type = TYPE_STEEL,
        .accuracy = B_CHAMPIONS_MOVE_UPDATES ? 95 : 100,
        .pp = 5,
        .target = TARGET_BOTH,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        ...
        {
            .moveEffect = MOVE_EFFECT_STAT_MINUS,
            .spAtk = B_CHAMPIONS_MOVE_UPDATES ? 2 : 1,
            .self = TRUE,
        }),
    ...
    [MOVE_DOUBLE_SHOCK] =
    {
        ...
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .punchingMove = B_CHAMPIONS_MOVE_UPDATES ? TRUE : FALSE,
        .metronomeBanned = TRUE,
    ...
    [MOVE_BLAZING_TORQUE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Powerful spin while aflame.\n"
            "May burn the target."),
        .effect = EFFECT_HIT,
        .power = B_CUSTOMIZED_MOVE_STATS == TRUE ? 95 : 80,
        .type = TYPE_FIRE,
        .accuracy = 100,
        .pp = 10,
        .target = TARGET_SELECTED,
    ...
    [MOVE_WICKED_TORQUE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Powerful spin with malice.\n"
            "May put the target asleep."),
        .effect = EFFECT_HIT,
        .power = B_CUSTOMIZED_MOVE_STATS == TRUE ? 95 : 80,
        .type = TYPE_DARK,
        .accuracy = 100,
    ...
    [MOVE_NOXIOUS_TORQUE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Powerful spin with fumes.\n"
            "May poison the target."),
        .effect = EFFECT_HIT,
        .power = B_CUSTOMIZED_MOVE_STATS == TRUE ? 95 : 100,
        .type = TYPE_POISON,
        .accuracy = 100,
        .pp = 10,
        .target = TARGET_SELECTED,
    ...
    [MOVE_SYRUP_BOMB] =
    {
        ...
        .power = 60,
        .type = TYPE_GRASS,
        .accuracy = B_CHAMPIONS_MOVE_UPDATES ? 90 : 85,
        .pp = 10,
        .target = TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_DRAGON_CHEER] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .soundMove = B_CHAMPIONS_MOVE_UPDATES ? TRUE : FALSE,
        .ignoresSubstitute = TRUE,
        ...
        [MOVE_STEELSURGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Sets sharp steel that\n"
            "hurts a foe switching in."),
