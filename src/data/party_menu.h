...
#define ROTOM_HEAT_MOVE  MOVE_HEAT_WAVE
#define ROTOM_WASH_MOVE  MOVE_SCALD
...
#define PIKACHU_POP_STAR_MOVE  MOVE_DAZZLING_GLEAM
#define PIKACHU_PHD_MOVE       MOVE_LUSTER_PURGE
