...
const u8 gText_UnlimitedRepelOn[] = _("The Unlimited Repel was turned on.{PAUSE_UNTIL_PRESS}");
const u8 gText_UnlimitedRepelOff[] = _("The Unlimited Repel was turned off.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NoRoamersAround[] = _("There doesn't seem to be any more\nRoamers around...");
...
const u8 gText_XNatureDistantPast[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nfrom the distant past.");
const u8 gText_XNatureFarFuture[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nfrom the far future.");
...
const u8 gText_EggFromHotSprings[] = _("A Pokémon Egg obtained\nfrom the Day Care."); // said hot springs, but changed to reflect new Day Care script.
