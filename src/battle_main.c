...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_POKEMANIAC] = { _("POKé MANIAC"), 15, BALL_PREMIER },
    [TRAINER_CLASS_GUITARIST] = { _("GUITARIST"), 8, BALL_FAST},
    [TRAINER_CLASS_KINDLER] = { _("KINDLER"), 8, BALL_CHERISH },
    [TRAINER_CLASS_CAMPER] = { _("CAMPER"), 4 , BALL_SAFARI},
    [TRAINER_CLASS_PICNICKER] = { _("PICNICKER"), 4 , BALL_SAFARI},
    ...
    [TRAINER_CLASS_POKEFAN] = { _("POKé FAN"), 20, BALL_FRIEND },
    ...
    [TRAINER_CLASS_DRAGON_TAMER] = { _("DRAGON TAMER"), 12, BALL_PREMIER },
    [TRAINER_CLASS_NINJA_BOY] = { _("NINJA BOY"), 3, BALL_DUSK },
    [TRAINER_CLASS_BATTLE_GIRL] = { _("BATTLE GIRL"), 6, BALL_QUICK },
    ...
    [TRAINER_CLASS_DIVER] = { _("DIVER"), 5, BALL_DIVE },
    [TRAINER_CLASS_BACKPACKER] = { _("BACKPACKER"), 10 },
    [TRAINER_CLASS_FAIRY_TALE_GIRL] = { _("FAIRY GIRL"), 10, BALL_LOVE },
    [TRAINER_CLASS_DELINQUENT] = { _("DELINQUENT"), 6, BALL_DUSK },
    [TRAINER_CLASS_STREET_THUG] = { _("STREET THUG"), 6, BALL_DUSK },
    [TRAINER_CLASS_MECHA_DOLL] = { _("MECHA"), 10 },
    [TRAINER_CLASS_ACE_DUO] = { _("ACE DUO"), 10 },
    [TRAINER_CLASS_BRAINS_AND_BRAWN] = { _("BRAINS&BRAWN"), 10 },
    [TRAINER_CLASS_MYSTERIOUS_SISTERS] = { _("MYSTERY SIS"), 10 },
    [TRAINER_CLASS_LEADERS] = { _("LEADERS"), 10 },
...
s32 GetBattleMovePriority(enum BattlerId battler, enum Ability ability, enum Move move)
{
    ...
    else if (ability == ABILITY_BLITZ_BOXER && gMovesInfo[move].punchingMove)
    {
        priority += 1;
    }
...
enum Type GetDynamicMoveType(struct Pokemon *mon, enum Move move, enum BattlerId battler, enum MonState state)
{
    ...
    case EFFECT_WEATHER_BALL:
        if (state == MON_IN_BATTLE)
        {
            ...
            if (weather & B_WEATHER_SUN && holdEffect != HOLD_EFFECT_UTILITY_UMBRELLA) //remove the && utility umbrella if compile errors
                return TYPE_FIRE;
            else if (weather & B_WEATHER_RAIN && holdEffect != HOLD_EFFECT_UTILITY_UMBRELLA) //remove the && utility umbrella if compile errors
                return TYPE_WATER;
