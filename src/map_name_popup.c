...
static const u8 sMapSectionToThemeId[MAPSEC_COUNT - KANTO_MAPSEC_COUNT - 1] =
{
    ...
    //[MAPSEC_ROUTE_104_NORTH - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    ...
    //[MAPSEC_VERDANT_GROVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    //[MAPSEC_ROUTE_111_SOUTH - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    //[MAPSEC_ROUTE_111_NORTH - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    //[MAPSEC_MIRAGE_DESERT - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    //[MAPSEC_WEATHER_INSTITUTE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_OLDALE_RUINS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
};
