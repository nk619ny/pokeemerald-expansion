...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_POWERHERB_RECHARGE]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} recharged instantly due to its Power Herb!"), //best practice is use LAST_ITEM variable, but since only one item does this, it works for now.
    ...
    [STRINGID_FRISKACTIVATES]                       = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} frisked {B_SCR_NAME_WITH_PREFIX2} and blocked its {B_LAST_ITEM}!"),
    ...
    [STRINGID_EXTREMESUNLIGHTFADED]                 = COMPOUND_STRING("The extremely harsh sunlight eased up slightly!"),
    ...
    [STRINGID_HEAVYRAINLIFTED]                      = COMPOUND_STRING("The deluge of rain lightened somewhat!"),
    ...
    [STRINGID_HOSPITALITYRESTORATIONGENERIC]        = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} was healed by {B_SCR_NAME_WITH_PREFIX2}!"),
    ...
    [STRINGID_ANTICIPATIONSWITCHIN]                  = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} is anticipating attacks!"),
    [STRINGID_ANTICIPATIONREDUCESDMG]                = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s anticipation reduced the damage!"),
...
const u16 gSwitchInAbilityStringIds[] =
{
    ...
    [B_MSG_SWITCHIN_ILLUMINATE] = STRINGID_ABILITYLOWEREDSURROUNDINGEVASION,
    [B_MSG_SWITCHIN_ANTICIPATION_ATTACKS] = STRINGID_ANTICIPATIONSWITCHIN,
...
const u16 gWeatherStartsStringIds[] =
{
    ...
    [WEATHER_FOG_HORIZONTAL]     = STRINGID_SUNLIGHTISHARSH, //STRINGID_FOGISDEEP,
